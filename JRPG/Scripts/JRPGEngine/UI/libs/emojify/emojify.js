(function (root, factory) {
   ...
   /* :-[ / :-@  */ rage: /:-?[\[@]/g,
         ...
         /* :-1: */ thumbsdown: /:\-1:/g
            ...
            function in_blacklist(name, list)
            {              
              var match = name.match(list);              
              return (name && match && match[0].toLowerCase() === name.toLowerCase());              
            }
...
*/
                            if(in_blacklist(node.tagName, elementsBlacklist) || node.tagName === "svg" || in_blacklist(node.className, classesBlacklist)) {
                                return win.NodeFilter.FILTER_REJECT;
                            }
